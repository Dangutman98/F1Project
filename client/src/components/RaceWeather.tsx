      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            <div className="p-6">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">F1 Race Weather</h1>
                  ...
                  <div key={race.spotName} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden relative">
                    <div className="p-6">
                      ...
                      {race.weather ? (
                          ...
                          <div className="text-center">
                            ...
                            <div className="mt-3">
                              <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${
                                race.status === 'current' ? 'bg-green-100 text-green-800' :
                        ...
                        <div className="text-center">
                          <p className="text-gray-500 dark:text-gray-400 mb-4">Weather data unavailable</p>
                          <div className="mt-3">
                            <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${
                              race.status === 'current' ? 'bg-green-100 text-green-800' :
                              race.status === 'upcoming' ? 'bg-blue-100 text-blue-800' :
