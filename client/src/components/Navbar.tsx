        ...
        <div className="flex flex-col py-1">
          ...
          <div className="flex items-center space-x-2 overflow-x-auto mt-2">
            <button
              ...
              className="text-black hover:text-gray-700 px-2 py-0.5 text-sm whitespace-nowrap"
            >
              My Profile
            </button>
            <button
            ...
            <div className="flex items-center ml-auto space-x-4">
              ...
              <button
                ...
                className="bg-white text-red-600 px-2 py-0.5 rounded-md hover:bg-gray-100 text-sm whitespace-nowrap"
              >
                Logout
              </button>
            </div>
